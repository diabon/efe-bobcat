Citizen.CreateThread(function()
    ...
    AddBoxZone("PDArmory", vector3(480.99, -995.45, 30.69), 1, 3.2, {
	name="PDArmory",
	heading=4.7,
	debugPoly=false,
    minZ=27.54,
...
--------------------- BURGER SHOT -----------------------------------------------
    ...
    AddCircleZone("burgertrey", vector3(-1194.06, -894.24, 14.0), 0.37,  {
        name="burgertrey",
        debugPoly=false,
        useZ=true,
        }, {
            options = {
                {
                    event = "logic-foodchain:pickupPrompt",
        ...
        AddCircleZone("burgertrey2", vector3(-1195.32, -892.31, 14.0), 0.37,  {
        name="burgertrey2",
        debugPoly=false,
        useZ=true,
        }, {
        ...
        AddBoxZone("burgershotself", vector3(-1197.83, -894.42, 14.0), 4.55, 1.0, {
        name="burgershotself",
        heading=34,
        --debugPoly=true,
        minZ=7.4,
        maxZ=14.8
            ...
            options = {
                {
                    event = "logic-foodchain:shelfPrompt",
        ...
        AddCircleZone("burgerdelivery", vector3(-1179.18, -892.22, 13.78), 1.58, {
        name="burgerdelivery",
        useZ=true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startjob",
                    icon = "fas fa-car",
        ...
        AddCircleZone("burgershot1", vector3(996.89, -2123.45, 30.48), 9.6, {
        name ="burgershot1",
        useZ = false,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startprocess",
                    icon = "fas fa-hand-holding",
                    label = "Grab Cow",
                },
             },
        ...
        AddCircleZone("burgershot2", vector3(984.74, -2121.76, 30.48), 1.0, {
        name ="burgershot2",
        useZ = true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startprocess2",
                    icon = "fas fa-hand-holding",
                    label = "Cutup Cow",
                },
             },
        ...
        AddCircleZone("burgershot3", vector3(976.57, -2121.56, 30.48), 2.0, {
        name ="burgershot3",
        useZ = true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startprocess3",
                    icon = "fas fa-hand-holding",
                    label = "Process Cutup Cow",
                },
             },
             job = {"all"},
            distance = 2.5
        ...
        AddCircleZone("burgershot4", vector3(-1202.89, -897.28, 14.0), 0.93, {
        name ="burgershot4",
        useZ = true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startprocess4",
        ...
        AddCircleZone("burgerfryer", vector3(-1201.99, -899.31, 14.0), 1.6, {
        name ="burgerfryer",
        useZ = true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:startfryer",
        ...
        AddCircleZone("burgershotmshack", vector3(-1199.23, -896.11, 14.0), 0.68, {
        name ="burgershotmshack",
        useZ = false,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:makeshake",
                    icon = "fas fa-hand-holding",
                    label = "Make Malk Shake",
                },
             },
             job = {"all"},
            distance = 2.5
        ...
        AddCircleZone("bugershotcola", vector3(-1199.81, -895.17, 14.0), 0.68, {
        name ="bugershotcola",
        useZ = false,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "logic-burgershot:getcola",
                    icon = "fas fa-hand-holding",
                    label = "Get Coke",
                },
             },
        ...
        AddCircleZone("burgershotstash", vector3(-1203.68, -895.78, 14.0), 0.87, {
        name ="burgershotstash",
        useZ = false,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "burgershot:stash",
                    icon = "fas fa-search",
                    label = "Open Fridge",
                },
             },
        ...
        AddCircleZone("burgershotfinish", vector3(-1199.5, -902.45, 14.0), 1.0, {
        name ="burgershotfinish",
        useZ = true,
        --debugPoly=true
        }, {
            options = {
                {
                    event = "burgershot:craftburger",
                    icon = "fas fa-hamburger",
                    label = "Make Burger",
                },
             },
